...
import { Carousel,Menu,Card } from 'antd';
import {UserOutlined,ShoppingCartOutlined,HomeOutlined,ReadOutlined,ProfileOutlined} from '@ant-design/icons';
        ...
        <Layout >
            ...
            <Layout>
                ...
                <Content>
                      ...
                      <div className="showCircle" style={{marginTop:0,textAlign:'center',marginLeft:'15vw'}}>
